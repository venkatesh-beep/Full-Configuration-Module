/* =========================================================
 * outpass-policies.js — BeeForce Configuration Portal
...
function init(ctx) {
  ...
  if (!document.getElementById("screen-outpol")) {
    var main = document.createElement("div");
    main.id = "screen-outpol"; main.style.display = "none";
    main.innerHTML =
      '<div class="bf-breadcrumb"><span class="bc-link" data-go="screen-hub">🏠 Home</span><span class="bc-sep">›</span><span class="bc-cur">🚪 Outpass Policies</span></div>' +
      '<div class="bf-module-header"><div class="mh-icon">🚪</div><div><div class="mh-title">Outpass Policies</div><div class="mh-sub">Not yet configured</div></div></div>' +
