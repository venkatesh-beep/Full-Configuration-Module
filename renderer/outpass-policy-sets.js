/* =========================================================
 * outpass-policy-sets.js — BeeForce Configuration Portal
...
function init(ctx) {
  ...
  if (!document.getElementById("screen-outpolset")) {
    var main = document.createElement("div");
    main.id = "screen-outpolset"; main.style.display = "none";
    main.innerHTML =
      '<div class="bf-breadcrumb"><span class="bc-link" data-go="screen-hub">🏠 Home</span><span class="bc-sep">›</span><span class="bc-cur">🚪 Outpass Policy Set</span></div>' +
      '<div class="bf-module-header"><div class="mh-icon">🚪</div><div><div class="mh-title">Outpass Policy Set</div><div class="mh-sub">Not yet configured</div></div></div>' +
